    ...
    <>
      ...
      <section className="bg-primary-700 text-white py-20">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-primary-100 max-w-2xl mx-auto">We are here to answer your questions about programs, partnerships, donations, and more.</p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <SectionHeader title="Get in Touch" subtitle="Reach out to Nurses Nook through any of the channels below." centered={false} />
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Nurses Nook</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Main Office: (920) 846-1234</p>
                    <p className="text-slate-600">Program Hotline: (920) 846-1235</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Saturday: 10:00 AM - 2:00 PM CST</p>
              ...
              <div className="mt-8 p-6 bg-slate-50 rounded-xl">
                ...
                <p className="text-sm text-slate-600">Federal EIN: 92-2233469</p>
                <p className="text-sm text-slate-600">Wisconsin Entity ID: N030943</p>
              ...
              <div className="bg-slate-50 p-8 rounded-2xl">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div><label className="block text-sm font-medium text-slate-700 mb-1">Subject</label><select required value={formData.subject} onChange={e => setFormData({...formData, subject: e.target.value})} className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary-500 outline-none"><option value="">Select a subject</option><option value="programs">Programs & Services</option><option value="donate">Donations & Sponsorship</option><option value="volunteer">Volunteering</option><option value="partnership">Partnership Opportunities</option><option value="media">Media Inquiry</option><option value="other">Other</option></select></div>
